...
- 참여자들에게 주제에 대한 정보를 전달하고, 상호 대화를 통해 다른 사람들과의 소통, 이해, 공감의 경험을 제공합니다.
- 참여 경험이 적은 시민들이 다양한 방식으로 참여할 수 있는 기회를 만듭니다.
- 공론장 플랫폼을 통해 공론장 관련 기록과 정보를 공개하여 공론 확산과 문제 해결에 기여합니다. 

### 작은 공론장을 기획, 운영할 때 고려해야 할점이 있나요?
- **참여하는 시민 누구나 주제에 대해 충분히 논의할 수 있어야 합니다.**
...
- **작은 공론장의 기획과 운영, 결과의 반영 등 전반적인 과정을 사전에 설계하고, 이를 투명하게 공개합니다.**
...
## 2. 주제 선정과 기획
작은 공론장에서 다룰 주제의 범위에 따라 공론화의 형식과 내용이 달라집니다. 사회적 이슈, 기관의 주요 정책, 시민의 제안이나 의견, 시민참여플랫폼에 지속적으로 제기 되는 주제 중에 선정할 수 있습니다. 
...
## 3-1. 작은 공론장 기획
- 작은 공론장 개최 목적, 주제, 일시, 대상, 목표, 기간을 정합니다. 주제와 주요 참여 대상에 따라 구체적인 실행 방안과 콘텐츠를 마련해야 합니다.  
- 주제가 선정된 다음 작은 공론장 기획과 콘텐츠 작성 과정에서, 토론 질문과 자료 등이 시민이 참여할 수 있도록 기획되었는가 점검하며 진행합니다. 
  - 토론의 필요성에 공감할만한 내용인가?
...
- **온라인 작은 공론장 운영** 
  ...
  - 실행 기간 중 오프라인에서 작은 공론장이 열린다면, 참여자들에게 온라인 작은 공론장에도 참여할 것을 요청합니다. 참여하는 시민들이 스스로 공론장을 주변에 알리고 논의를 확산할 수 있도록 방법을 안내합니다.   
...
## 3-3. 오프라인 작은 공론장 기획과 운영
- 오프라인 작은 공론장은 의제 관련 이해관계자와 이에 관심있는 시민들에게 보다 직접적인 참여의 경험을 제공하고, 깊이있는 상호 토론을 통해 해당 의제에 대한 구체적인 대안, 정책 방안을 모색하는 장이 될 수 있습니다. 
- 오프라인 작은 공론장은 시간과 공간의 제약이 있습니다. 인원 규모에 관계없이 공론장 참여자가 충분히 자기 의견을 제시할 수 있도록 프로그램을 기획하고, 이용할 수 있는 방법을 준비합니다. 오프라인 현장에서 타운홀 같은 온라인 토론 플랫폼을 같이 활용하는 방법이 있습니다.  
- **오프라인 작은 공론장 기획** 
...
- **결과 콘텐츠 제작과 공개**
  ...
  - 공론 결과의 분석과 정리  
    ...
    - 다수가 참여했다면, 빅데이터 분석 도구를 활용해 토론 내용을 분석하고 결과를 담습니다. 
